...
var macMixin = {
  ...
  methods: {
    getFolderData: function getFolderData() {
      ...
      this.$getApi.queryAllFolder(JSON.parse(sessionStorage.getItem('getTidList'))).then(function (res) {
        if (res !== undefined) {
          if (res.length === 0) {
    ...
    getListData: function getListData(type) {
      ...
      if (_mac_methods_js__WEBPACK_IMPORTED_MODULE_2__["MacTypeBtn"].includes(type)) {
        this.$getApi.queryAllMachine(JSON.parse(sessionStorage.getItem('getTidList'))).then(function (res) {
          loadTime = true;
        ...
        this.$getApi.queryPumps(JSON.parse(sessionStorage.getItem('getTidList'))).then(function (res) {
          loadTime = true;
          _this4.$parent.loading = false; //关闭加载中
          ...
          if ($.isEmptyObject(_this4.initList.pump_macNameList)) {
            ...
            var result = Object(_mac_info_js__WEBPACK_IMPORTED_MODULE_1__["getPumpInfo"])(res, _this4.initList.pumpFolderData, _this4.initList.pump_macNameList, _this4.initList.pump_macIdList, type);
            var linkObj = ["", "", type];
