...
/*!****************************************************************!*\
  !*** ./src/components/content/system/dgm/table/js/dgm_info.js ***!
  \****************************************************************/
/*! exports provided: getDgmInfo, changeDgm, getMHDInfo, createMHD, createE821, createFlange, createPreps, createTms, createServerDgm, getArrFromObj, getIndexOfArr, captureFreqSources */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "captureFreqSources", function() { return captureFreqSources; });
...
var rt_tz_angleSource = {}; //倾角特征值实时上传间隔的下拉选项

var his_tz_angleSource = {}; //倾角特征值存储时间间隔的下拉选项

var rt_wave_angleSource = {}; //倾角波形实时上传间隔

var his_wave_angleSource = {}; //倾角波形存储时间间隔

var his_long_capSource = {}; //长采样时间间隔
...
var captureFreqSources = _utils_utils__WEBPACK_IMPORTED_MODULE_1__["captureFreqSourcesObj"]; //分析频率
...
var frequency_source = [500, 1000, 2000, 4000, 8000, 16000, 32000, 12800]; //轨道波磨分析频率

var spectral_source = [1600, 3200, 6400, 12800]; //轨道波磨谱线数

var if_activity_source = {
  '0': '禁用',
  '1': '开启'
}; //轨道波磨是否有效

var pos_accuracy_source = [50, 100, 150, 200, 250, 300, 400, 500]; //轨道波磨定位精度

/*主机从机设置*/

var speed_from_source = {
  "0": "X11转速输入",
  "1": "电压转速输入",
  "2": "X12转速输入",
  "3": "电流转速输入"
...
var wave_status_source = {
  "0": "关闭",
  "1": "开启"
}; // 是否发送波形状态

var vector_status_source = {
  "0": "关闭",
  "1": "开启"
}; // 是否发送特征值
  ...
  if (res === null || res === undefined || res.model === undefined || res.model === null || res.model.length === 0) {
    ...
    if (type == 1) {
      res.model.forEach(function (model) {
        /*V2、DGU2600、tmu2000、DGU2000E、YHC5000*/
        if (model.dgm_type == 3 || model.dgm_type == 5 || model.dgm_type == 7 || model.dgm_type == 9 || model.dgm_type == 13) {
          realTimeSource = {
            '127': '最快',
            '0': '3秒',
            '1': '5秒',
          ...
          if (company === 1 && (model.dgm_type == 3 || model.dgm_type == 9)) {
            rt_tz_angleSource = {
              '127': '最快',
              '0': '3秒',
              '1': '5秒',
          ...
          if (userType !== 0) {
            delete realTimeSource['127'];
            delete byVectorSource['127'];
            delete waveIntrvlSource['127'];
            delete bvWaveIntrvlSource['127'];
          }
        } else {
          realTimeSource = {
            '0': '3秒',
        ...
        if (model.dgm_type == 9 || model.dgm_type == 13) {
        ...
        dgm = {
          ...
          //（TMS采集器）  修改校正系数 0：否 1：是 默认0
          host_car_type: model.baseInfo.host_car_type,
          //主机车辆类型，0：TC1，1：TC2，2：MP1，3：MP2，4：MP2，5：MC2，默认空，必填
          frequency: model.baseInfo.frequency,
          //分析频率,{'0':'500','1':'1k','2':'2k','3':'4k','4':'8k','5':'16k','6':'32k','7':'12.8K'};//轨道波磨分析频率
          start_time: model.baseInfo.start_time,
          //开始时间,
          period: model.baseInfo.period,
          //周期,
          station_interval: model.baseInfo.station_interval,
          //报站间隔,
          oneway_time: model.baseInfo.oneway_time,
          //单程时间
          spectral: model.baseInfo.spectral,
          //谱线数 1600,3200,6400,12800
          pos_accuracy: model.baseInfo.pos_accuracy,
          //定位精度 50,100,150,200,250,300,400,500
          offline_mode: model.baseInfo.offline_mode,
          offline_mode_val: offline_modeSource[model.baseInfo.offline_mode],
          //离线数据上传系统
          offline_modeSources: Object.values(offline_modeSource),
          offline_modeSources_key: Object.keys(offline_modeSource),
          offline_send_start: Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["timeFor"])(model.baseInfo.offline_send_start * 60),
          //离线数据可上传时间-开始
          offline_send_end: Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["timeFor"])(model.baseInfo.offline_send_end * 60) //离线数据可上传时间-结束
        ...
        if (company === 1) {
          Object.assign(dgm, {
            rt_tz_angle: model.baseInfo.rt_tz_angle,
            rt_tz_angle_val: rt_tz_angleSource[model.baseInfo.rt_tz_angle],
            //倾角特征值实时上传间隔
            rt_tz_angleSources: Object.values(rt_tz_angleSource),
            rt_tz_angleSources_key: Object.keys(rt_tz_angleSource),
            his_tz_angle: model.baseInfo.his_tz_angle,
            his_tz_angle_val: his_tz_angleSource[model.baseInfo.his_tz_angle],
            //倾角特征值存储时间间隔
            his_tz_angleSources: Object.values(his_tz_angleSource),
            his_tz_angleSources_key: Object.keys(his_tz_angleSource),
            rt_wave_angle: model.baseInfo.rt_wave_angle,
            rt_wave_angle_val: rt_wave_angleSource[model.baseInfo.rt_wave_angle],
            //倾角波形实时上传间隔
            rt_wave_angleSources: Object.values(rt_wave_angleSource),
            rt_wave_angleSources_key: Object.keys(rt_wave_angleSource),
            his_wave_angle: model.baseInfo.his_wave_angle,
            his_wave_angle_val: his_wave_angleSource[model.baseInfo.his_wave_angle],
            //倾角波形存储时间间隔
            his_wave_angleSources: Object.values(his_wave_angleSource),
            his_wave_angleSources_key: Object.keys(his_wave_angleSource),
            his_long_cap: model.baseInfo.his_long_cap,
            his_long_cap_val: his_long_capSource[model.baseInfo.his_long_cap],
            //长采样存储时间间隔
            his_long_capSources: Object.values(his_long_capSource),
            his_long_capSources_key: Object.keys(his_long_capSource)
          });
        }
      ...
      res.model.forEach(function (model) {
        dgm = {
          ...
          sf_main_ver: model.baseInfo.sf_main_ver,
          //版本号
          freq: model.baseInfo.freq,
          //采样频率
          freqSources: [1024, 2048, 4096, 8192, 12800, 16384, 25600, 32768, 51200],
          sample: model.baseInfo.sample,
          //采样时间
          wave_intrvl: model.baseInfo.wave_intrvl,
          //波形采集间隔
          wave_status: model.baseInfo.wave_status,
          //是否发送波形状态
          wave_status_val: wave_status_source[model.baseInfo.wave_status],
          wave_status_Sources: Object.values(wave_status_source),
          wave_status_Sources_key: Object.keys(wave_status_source),
          vector_intrvl: model.baseInfo.vector_intrvl,
          //特征值采集间隔
          vector_status: model.baseInfo.vector_status,
          //是否发送特征值
          vector_status_val: vector_status_source[model.baseInfo.vector_status],
          vector_status_Sources: Object.values(vector_status_source),
          vector_status_Sources_key: Object.keys(vector_status_source),
          run_mode: model.baseInfo.run_mode,
          //运行模式
          run_mode_val: run_mode_source[model.baseInfo.run_mode],
          run_mode_Sources: Object.values(run_mode_source),
          run_mode_Sources_key: Object.keys(run_mode_source),
          wait_timeout: model.baseInfo.wait_timeout,
          //连接超时等待时间
          IEPE_time: model.baseInfo.IEPE_time,
          //IEPE稳定时间
          alarm_intrvl: model.baseInfo.alarm_intrvl,
          //报警下的采集间隔
          temperature_comp: model.baseInfo.temperature_comp,
          //温度补偿值
          hw_ab_ver: model.baseInfo.hw_ab_ver,
          hw_db_ver: model.baseInfo.hw_db_ver,
          sf_fix_ver: model.baseInfo.sf_fix_ver
    ...
    } else if (type == 10 || type == 20 || type == 21) {
      ...
      res.model.forEach(function (model) {
        ...
        if (model.main_host && model.main_host.length) {
          hostLists = model.main_host;
          hostLists.forEach(function (host) {
            host_id_source[host.pre_id] = host.byName;
          });
        }

        if (type == 20 || type == 21) {
          tmsLists = model.host_list;
          pumpList = model.pump;

          if (pumpList && pumpList.length) {
            pumpList.forEach(function (pump) {
              ch_class_source[pump.ch_class] = pump.pump_name;
            });
          }
        } else {
          tmsLists = model.tms_list;
        }

        if (tmsLists.length > 0) {
          tmsLists.forEach(function (tms, index) {
            dgm = {
              index: index,
              dgm_id: model.dgm_id,
              dgm_name: model.dgm_name,
              ...
              byId: tms.byId,
              byName: tms.byName,
              old_pre_id: tms.pre_id,
              pre_id: tms.pre_id,
              status: tms.status,
              car_id: tms.car_id,
              dev_id: tms.dev_id,
              status_val: statusSource[tms.status],
              host_id: tms.host_id,
              host_id_val: host_id_source[tms.host_id],
              host_id_sources: Object.values(host_id_source),
              host_id_sources_key: Object.keys(host_id_source),
              dev_type: 0,
              //0表示前置
              ch_class: tms.ch_class,
              ch_class_val: ch_class_source[tms.ch_class],
              ch_class_sources: Object.values(ch_class_source),
              ch_class_sources_key: Object.keys(ch_class_source)
            };

            if (type == 20 || type == 21) {
              dgm.netHostIp = tms.netHostIp;
              dgm.speed_from = tms.speed_from;
              dgm.speed_from_val = speed_from_source[tms.speed_from];
              dgm.speed_from_sources = Object.values(speed_from_source);
              dgm.speed_from_sources_key = Object.keys(speed_from_source);
              dgm.X11 = tms.X11;
              dgm.X11_val = X11_source[tms.X11];
              dgm.X11_sources = Object.values(X11_source);
              dgm.X11_sources_key = Object.keys(X11_source);
              dgm.X12 = tms.X12;
              dgm.X12_val = X11_source[tms.X12];
              dgm.X12_sources = Object.values(X11_source);
              dgm.X12_sources_key = Object.keys(X11_source);
              dgm.dev_type = 1; //1主机
            }
      ...
      _models.forEach(function (model) {
        if (!flange_idList[model.dgm_id]) {
          flange_idList[model.dgm_id] = [];
        }

        if (model.pos_loc != 255) {
          //公共除外
          flange_idList[model.dgm_id].push(model.pos_loc);
        }
      });

      _models.forEach(function (model, index) {
        var posLocSource = Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["posClassToPosLoc"])(model.pos_class, 5, model.t_root);
        var this_flange_posLoc = flange_idList[model.dgm_id];

        if (model.pos_class != 0) {
          for (var key in posLocSource) {
            if (this_flange_posLoc.includes(key) && model.pos_loc != key) {
              delete posLocSource[key];
            }
          }
        }

        model.posLocSource = posLocSource;
      ...
      var _dgmList = {};
      var flangeList = {};
      var keys = {}; //同一采集器下法兰id列表

      var values = {}; //同一采集器下法兰名称列表
      ...
      _dgmInfo.forEach(function (dgm) {
        ...
        keys[dgm.dgm_id] = [255];
        values[dgm.dgm_id] = ['无'];
        var dgmFlangeList = dgm.flangeList.sort(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["compareName"])('byName')); //根据法兰名称排序

        dgmFlangeList.forEach(function (flange) {
          flangeList[dgm.dgm_id][flange.byId] = flange.byName;
          keys[dgm.dgm_id].push(flange.byId);
          values[dgm.dgm_id].push(flange.byName);
        });
      });

      var _arr = [];

      _models2.forEach(function (model, index) {
        dgm = {
          index: index,
          dgm_id_byName: model.dgm_id + '_' + model.byName,
          ...
          flangeSources: values[model.dgm_id],
          flangeSources_keys: keys[model.dgm_id],
      ...
      res.model.forEach(function (model) {
        if (model.baseInfo.cap_type == undefined) {
          model.baseInfo.cap_type = 0;
        }
        ...
        dgm = {
          ...
          dgm_type: model.dgm_type,
          machineId: model.machineId,
          cap_type: model.baseInfo.cap_type,
          //波磨采样触发类型
          cap_type_val: cap_type_source[model.baseInfo.cap_type],
          cap_type_sources_key: Object.keys(cap_type_source),
          cap_type_sources: Object.values(cap_type_source),
          frequency: model.baseInfo.frequency,
          //分析频率
          frequency_sources_key: frequency_source,
          frequency_sources: frequency_source,
          spectral: model.baseInfo.spectral,
          //谱线数
          spectral_sources: spectral_source,
          spectral_sources_key: spectral_source,
          pos_accuracy: model.baseInfo.pos_accuracy,
          //定位精度
          pos_accuracy_sources: pos_accuracy_source,
          pos_accuracy_sources_key: pos_accuracy_source,
          start_time: model.baseInfo.start_time,
          //开始时间
          period: model.baseInfo.period,
          //周期
          ...
          oneway_time: model.baseInfo.oneway_time,
          //单程时间
          maxTime: model.maxTime //最大单程时间

        };
        Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["compute_frequency_spectral"])(dgm.frequency, dgm.spectral, dgm);
        data.push({
          dgm: dgm
        });
      });
      ...
      res.model.forEach(function (model) {
        ...
        if (type == 2) {
          ...
          sensorSource = Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["sensorTypeSource"])(model.dgmInfo.dgm_type, type); //传感器类型下拉选项
          ...
          if (model.dgmInfo.dgm_type == 1) {
            ...
            vibSignalZoomMaxVal = [10000, 2000, 400, 80, 50000];
            vibSignalZoomKey = ["2", "3", "4", "5", "6"];
            ...
            if (model.dgmInfo.hw_db_ver == 100) {
              ...
              vibSignalZoomMaxVal = ["自动量程", 40000, 4000, 500, 50];
              vibSignalZoomKey = ["0", "1", "9", "25", "29"];
            }
          } else if (model.dgmInfo.dgm_type == 3) {
            hwFilterSource = [['127', '自动滤波'], ['1', '1KHz'], ['2', '10KHz'], ['3', '40KHz']];
            var hw_db_ver = parseInt(model.dgmInfo.hw_db_ver); //db版本号

            var hw_range_type = model.dgmInfo.hw_range_type; //量程类型

            if (hw_db_ver <= 100 && hw_range_type == 0) {
              //group1=0 group2=0
              vibSignalZoomSource = [["0", "自动量程"], ["1", "0.5"], ["2", "2.5"], ["3", "12.5"]];
              vibSignalZoomMaxVal = ["自动量程", 8000, 1600, 320];
              vibSignalZoomKey = ["0", "1", "2", "3"];
            } else if (hw_db_ver <= 100 && hw_range_type != 0) {
              //group1=0 group2=1
            ...
            } else if (hw_db_ver > 100 && hw_db_ver < 105 && hw_range_type == 0) {
              //group1=1 group2=0
            ...
            } else if (hw_db_ver >= 105 && hw_range_type == 0) {
              //group1=2 group2=0
              vibSignalZoomSource = [["0", "自动量程"], ["1", "0.0625"], ["2", "0.625"], ["3", "2.5"], ["4", "25"]];
              vibSignalZoomMaxVal = ["自动量程", 20000, 2000, 500, 50];
              vibSignalZoomKey = ["0", "1", "2", "3", "4"];
            }
          } else if (model.dgmInfo.dgm_type == 9 || model.dgmInfo.dgm_type == 13) {
            //dgu2000E、YHC5000
            vibSignalZoomMaxVal = [10000, 100];
            vibSignalZoomKey = ["0", "1"];
            hwFilterSource = [['127', '自动滤波'], ['1', '10Hz'], ['2', '1KHz'], ['3', '40KHz']];

            if (model.dgmInfo.dgm_type == 13) {
              hwFilterSource = [['127', '自动滤波'], ['1', '100Hz'], ['2', '40KHz']];
            }
          ...
          unitSource = Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["unitToSources"])(sensorUnit, model.baseInfo.vib.byIntegral, model.dgmInfo.dgm_type, model.baseInfo.vib.bySensorType)[0];
          integralSource = Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["unitToSources"])(sensorUnit, model.baseInfo.vib.byIntegral, model.dgmInfo.dgm_type, model.baseInfo.vib.bySensorType)[1];
          ...
          Object.assign(dgm, {
            ...
            pos_loc_old: model.baseInfo.vib.pos_loc,
            ...
            tms_wheel: model.baseInfo.vib.tms_wheel,
            //tms的关联通道
            ...
            pos_part1: model.baseInfo.vib.pos_part1,
            pos_part1_val: posPartSource[model.baseInfo.vib.pos_part1],
            pos_part2: model.baseInfo.vib.pos_part2,
            pos_part2_val: posPartSource[model.baseInfo.vib.pos_part2],
            pos_part3: model.baseInfo.vib.pos_part3,
            pos_part3_val: posPartSource[model.baseInfo.vib.pos_part3],
            pos_part4: model.baseInfo.vib.pos_part4,
            pos_part4_val: posPartSource[model.baseInfo.vib.pos_part4],
            pos_part5: model.baseInfo.vib.pos_part5,
            pos_part5_val: posPartSource[model.baseInfo.vib.pos_part5],
            pos_part6: model.baseInfo.vib.pos_part6,
            pos_part6_val: posPartSource[model.baseInfo.vib.pos_part6],
            pos_part7: model.baseInfo.vib.pos_part7,
            pos_part7_val: posPartSource[model.baseInfo.vib.pos_part7],
            pos_part8: model.baseInfo.vib.pos_part8,
            pos_part8_val: posPartSource[model.baseInfo.vib.pos_part8],
            pos_part9: model.baseInfo.vib.pos_part9,
            pos_part9_val: posPartSource[model.baseInfo.vib.pos_part9],
            if_activity: model.baseInfo.vib.if_activity,
            if_activity_val: if_activity_source[model.baseInfo.vib.if_activity],
            //是否开启轨道波磨
            if_activity_sources_key: Object.keys(if_activity_source),
            if_activity_sources: Object.values(if_activity_source),
            ...
            //接线方式 0 2线　 1 3线
            supply_voltage: model.baseInfo.vib.supply_voltage,
            //供电电压 0 +24V 1 -24V
            maxChannelSize: model.maxChannelSize //该前置可以设置为轨道波磨的通道的最大个数

          });

          if (model.dgmInfo.dgm_type != 7) {
            //非tms2000采集器的是否开启轨道波磨显示置空
            dgm.if_activity = '';
          }
        } //温度设置
        ...
        if (type == 3) {
          ...
          if (model.dgmInfo.dgm_type == 2) {
          ...
          } else if (model.dgmInfo.dgm_type == 3 || model.dgmInfo.dgm_type == 9) {
            ...
            if (model.dgmInfo.hw_db_ver >= 105) {
              rangeSource = {
                "0": "20000mV",
                "1": "2500mV"
              };
            }
          } else if (model.dgmInfo.dgm_type == 7 || model.dgmInfo.dgm_type == 13) {
            rangeSource = {
              "255": "固定量程"
            };
          }
          ...
          Object.assign(dgm, {
            ...
            pos_part: model.baseInfo.temp.pos_part,
            pos_part_val: posPartSource[model.baseInfo.temp.pos_part],
            posPartSources: Object.values(posPartSource),
            posPartSources_key: Object.keys(posPartSource),
        ...
        if (type == 4) {
          ...
          } else if (model.dgmInfo.dgm_type == 9) {
            staByStaTypeSource = {
              '1': '0~5V',
              '2': '4~20mA'
            };
          ...
          Object.assign(dgm, {
            ...
            //零漂
            dwCorr: model.baseInfo.sta.dwCorr,
            //校正系数
            trans_ch_type: model.trans_ch_type,
            //是否振动转温度：0振动通道；4转温度通道; 3表示9通道（通道不能转）
            trans_ch_type_val: transChTypeSource[model.trans_ch_type],
            transChTypeSources: Object.values(transChTypeSource),
            transChTypeSources_key: Object.keys(transChTypeSource),
            bind_count: model.bind_count //是否绑定测点

          });

          if (model.dgmInfo.dgm_type != 6 && model.dgmInfo.dgm_type != 9) {
            //非821采集器的传感器类型显示置空
        ...
        if (type == 5) {
          ...
          if (model.dgmInfo.dgm_type != 7) {
            ...
            model.baseInfo.speed.speedRate = ''; ////tms采集器的转速比speedRate,其他采集器没有这个字段置空

            model.baseInfo.speed.baseRate = ''; //tms采集器的基准转速比baseRate,其他采集器没有这个字段置空
          }

          if ((model.dgmInfo.dgm_type == 3 || model.dgmInfo.dgm_type == 9 || model.dgmInfo.dgm_type == 13) && model.ch_id == 0 || model.dgmInfo.dgm_type == 1 && model.ch_id == 16) {
            byStrongTypeSource = {
              "255": "无增益"
            };
            ...
            } else if (Number(model.dgmInfo.hw_db_ver) > 104) {
              //db版本号大于等于105的键相增益
              byStrongTypeSource = {
                "0": "0.8",
                "1": "1",
          ...
          } else if (model.dgmInfo.dgm_type == 13) {
            //YHC5000比较电压值
            dwCompreVoltSources = {
              "2": "固定"
            }; //比较电压
          ...
          Object.assign(dgm, {
            ...
            //单位名称
            pos_part: model.baseInfo.speed.pos_part,
            pos_part_val: posPartSource[model.baseInfo.speed.pos_part],
            posPartSources: Object.values(posPartSource),
            posPartSources_key: Object.keys(posPartSource),
            ...
            //直流校正系数	float
            dwSpeed_Null_shift: model.baseInfo.speed.dwSpeed_Null_shift,
            //直流零点偏移	float
            baseRate: model.baseInfo.speed.baseRate,
            //基础转速比
            speedRate: model.baseInfo.speed.speedRate //转速比
        ...
        if (type == 9) {
          ...
          captureTimeSource = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["freqToCaptureTime"])(model.baseInfo.capture.capture_freq);
          ...
          Object.assign(dgm, {
            ...
            capture_time_val: Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["findKey"])(model.baseInfo.capture.capture_time, captureTimeSource),
            //采样时间
            captureTimeSources: Object.keys(captureTimeSource),
            captureTimeSources_key: Object.values(captureTimeSource),
        ...
        if (type == 16) {
          ...
          if (res.flangeInfo != undefined && res.flangeInfo != null && res.flangeInfo[model.dgmInfo.dgm_id] != undefined && res.flangeInfo[model.dgmInfo.dgm_id] != null && res.flangeInfo[model.dgmInfo.dgm_id].length > 0) {
            ...
            _flangeList = _flangeList.sort(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["compareName"])('flange_name')); //根据法兰名称排序

            _flangeList.forEach(function (flange) {
              posLocSource[flange.flange_id] = flange.flange_name; //安装位置下拉选项

              _keys.push(flange.flange_id);

              _values.push(flange.flange_name);
            ...
            Object.assign(dgm, {
              ...
              //安装位置
              posLocSources: _values,
              posLocSources_key: _keys,
...
function changeDgm(type, oldDgm, index) {
  ...
  if (type == 17) {
    ...
    dgm = {
      change_channels: oldDgm.change_channels,
      config_state: oldDgm.config_state,
      deleteType: oldDgm.deleteType,
      dgm_state: oldDgm.dgm_state,
      dgm_state_time: oldDgm.dgm_state_time,
      machineId: oldDgm.machineId,
      ...
      baseInfo: {
        ...
        freq: oldDgm.freq,
        //采样频率
        sample: oldDgm.sample,
        //采样时间
        wave_intrvl: oldDgm.wave_intrvl,
        //波形采集间隔
        wave_status: oldDgm.wave_status,
        //是否发送波形状态
        vector_intrvl: oldDgm.vector_intrvl,
        //特征值采集间隔
        vector_status: oldDgm.vector_status,
        //是否发送特征值
        run_mode: oldDgm.run_mode,
        //运行模式
        wait_timeout: oldDgm.wait_timeout,
        //连接超时等待时间
        IEPE_time: oldDgm.IEPE_time,
        //IEPE稳定时间
        alarm_intrvl: oldDgm.alarm_intrvl,
        //报警下的采集间隔
        temperature_comp: oldDgm.temperature_comp //温度补偿值
    ...
    dgm.byName = oldDgm.byName;
    dgm.old_pre_id = oldDgm.old_pre_id;
    dgm.pre_id = oldDgm.pre_id;
    dgm.status = oldDgm.status;
    dgm.host_id = oldDgm.host_id;
    dgm.dev_type = oldDgm.dev_type;

    if (type == 20 || type == 21) {
      dgm.netHostIp = oldDgm.netHostIp;
      dgm.speed_from = oldDgm.speed_from;
      dgm.X11 = oldDgm.X11;
      dgm.X12 = oldDgm.X12;
    ...
    dgm.baseInfo = {
      cap_type: oldDgm.cap_type,
      //波磨采样触发类型
      frequency: Number(oldDgm.frequency),
      spectral: Number(oldDgm.spectral),
      //谱线数
      pos_accuracy: oldDgm.pos_accuracy,
      //定位精度
      start_time: oldDgm.start_time,
      //开始时间
      period: oldDgm.period,
      //周期
      station_interval: oldDgm.station_interval,
      //报站间隔
      oneway_time: oldDgm.oneway_time //单程时间
    ...
    if (type == 1) {
      ...
      if (oldDgm.dgm_type == 7) {
        ...
        dgm.baseInfo.need_save_corr = oldDgm.need_save_corr; //（TMS采集器）  修改校正系数 0：否 1：是 默认0

        dgm.baseInfo.host_car_type = oldDgm.host_car_type; //主机车辆类型，0：TC1，1：TC2，2：MP1，3：MP2，4：MP2，5：MC2，默认空，必填

        dgm.baseInfo.frequency = oldDgm.frequency; //分析频率,{'0':'500','1':'1k','2':'2k','3':'4k','4':'8k','5':'16k','6':'32k','7':'12.8K'};//轨道波磨分析频率

        dgm.baseInfo.start_time = oldDgm.start_time; //开始时间,

        dgm.baseInfo.period = oldDgm.period; //周期,

        dgm.baseInfo.station_interval = oldDgm.station_interval; //报站间隔,

        dgm.baseInfo.oneway_time = oldDgm.oneway_time; //单程时间

        dgm.baseInfo.spectral = oldDgm.spectral; //谱线数 1600,3200,6400,12800

        dgm.baseInfo.pos_accuracy = oldDgm.pos_accuracy;
        dgm.baseInfo.offline_mode = oldDgm.offline_mode; //离线数据上传系统

        dgm.baseInfo.offline_send_start = Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["unformatTimes"])(oldDgm.offline_send_start) / 60; //离线数据可上传时间-开始

        dgm.baseInfo.offline_send_end = Object(_dgm_methods_js__WEBPACK_IMPORTED_MODULE_0__["unformatTimes"])(oldDgm.offline_send_end) / 60; //离线数据可上传时间-结束
      }
      /* 金风 DGU2000V2、DGU2000E*/


      if (company === 1 && (oldDgm.dgm_type == 3 || oldDgm.dgm_type == 9)) {
        Object.assign(dgm.baseInfo, {
          rt_tz_angle: oldDgm.rt_tz_angle,
          his_tz_angle: oldDgm.his_tz_angle,
          rt_wave_angle: oldDgm.rt_wave_angle,
          his_wave_angle: oldDgm.his_wave_angle,
          his_long_cap: oldDgm.his_long_cap
        });
      }
    } else {
      ...
      if (type == 2) {
        dgm.pre_id = oldDgm.pre_id;
        dgm.host_id = oldDgm.host_id; //主机id
        ...
        dgm.baseInfo.vib = {
          ...
          pos_loc: oldDgm.pos_loc,
          pos_loc_old: oldDgm.pos_loc_old,
          pos_part: oldDgm.pos_part,
          pos_part1: oldDgm.pos_part1,
          pos_part2: oldDgm.pos_part2,
          pos_part3: oldDgm.pos_part3,
          pos_part4: oldDgm.pos_part4,
          pos_part5: oldDgm.pos_part5,
          pos_part6: oldDgm.pos_part6,
          pos_part7: oldDgm.pos_part7,
          pos_part8: oldDgm.pos_part8,
          pos_part9: oldDgm.pos_part9,
          ...
          //供电电压 0 +24V 1 -24V
          if_activity: oldDgm.if_activity,
          //是否开启轨道波磨
          tms_wheel: oldDgm.tms_wheel //关联车轮
      ...
      if (type == 4) {
        dgm.baseInfo = {};
        dgm.trans_ch_type = oldDgm.trans_ch_type, dgm.bind_count = oldDgm.bind_count, dgm.baseInfo.sta = {
      ...
      if (type == 5) {
        ...
        dgm.baseInfo.speed = {
          ...
          //直流校正系数	float
          dwSpeed_Null_shift: oldDgm.dwSpeed_Null_shift,
          //直流零点偏移	float
          pos_part: oldDgm.pos_part,
          //关联部件
          baseRate: oldDgm.baseRate,
          //基础转速比
          speedRate: oldDgm.speedRate //转速比
...
function createMHD(mhdList, data) {
  var ifOutputSource = {
    '0': '不输出',
    '1': '输出'
  };
...
function createFlange(dgmList, data) {
...
function createPreps(dgmList, flangeList, data) {
...
function createTms(tmsList, type, data) {
  var dgmSource = Object.values(tmsList);
  var dgmSources_key = Object.keys(tmsList);
  var dgm = {
    index: data.length,
    ...
    host_id_sources_key: {},
    dev_type: 0,
    speed_from: Object.keys(speed_from_source)[0],
    speed_from_val: Object.values(speed_from_source)[0],
    speed_from_sources: Object.values(speed_from_source),
    speed_from_sources_key: Object.keys(speed_from_source),
    X11: '0',
    X11_val: '输入',
    X11_sources: Object.values(X11_source),
    X11_sources_key: Object.keys(X11_source),
    X12: '1',
    X12_val: '输出',
    X12_sources: Object.values(X11_source),
    X12_sources_key: Object.keys(X11_source),
    ch_class: '',
    ch_class_val: '',
    ch_class_sources: {},
    ch_class_sources_key: {},
    netHostIp: '' //主机/分机IP
...
//# sourceMappingURL=5-39e36082.js.map