          ...
          if (item.col == 5) {
            ...
            for (var _i2 = 0; _i2 < rows; _i2++) {
              ...
              if (_this3.data[_rowNum].alarmBaseInfo.code == 2000) {
                ...
                _this3.hot.setCellMeta(_i2, item.col, "editor", "select");

                _this3.hot.setCellMeta(_i2, item.col, "selectOptions", function (row) {
                  return _this3.hot.toPhysicalRow(row).alarmBaseInfo.alarmIndexSources;
                });
              } else {
...
//# sourceMappingURL=12-53a110cf.js.map